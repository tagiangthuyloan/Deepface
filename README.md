## 1. Đăng ký Nhân viên & Khuôn mặt (`employees.py`, `worker.py`)

### **Mô tả**
Quản trị viên tạo hồ sơ nhân viên mới và đăng ký khuôn mặt cho nhân viên đó.  
Hệ thống AI sẽ kiểm tra chất lượng ảnh, trích xuất đặc trưng khuôn mặt (ArcFace Embedding) và tính toán vector đại diện trung bình (Average Embedding) để lưu vào Vector Database.
...
- Có từ **1 đến 5 ảnh khuôn mặt** của nhân viên.
...
### **Luồng thay thế**
- Upload ít hơn 1 hoặc nhiều hơn 5 ảnh:
  - Hệ thống báo lỗi.
  - Không tạo nhân viên.
